...
(141, 'GLT sandwich', '5.99', 390, 'Chef’s Table Breakfast', 'Lady Eaton');
(142, 'Veggie bagel supreme', '5.99', 470, 'Chef’s Table Breakfast', 'Lady Eaton');
(143, 'Toasted bagel', '2.49', 350, 'Chef’s Table Breakfast', 'Lady Eaton');
(144, 'Guac toast', '3.79', 440, 'Chef’s Table Breakfast', 'Lady Eaton');
(145, 'Toasted bagel', '3.79', 440, 'Chef’s Table Breakfast', 'Lady Eaton');
(146, '2 triangle hash browns', '2.29', 290, 'Chef’s Table Breakfast', 'Lady Eaton');
(147, 'Side of toast', '2.29', 220, 'Chef’s Table Breakfast', 'Lady Eaton');
(148, 'Add guac and hummus', '1.79', 270, 'Chef’s Table Breakfast', 'Lady Eaton');
(149, 'Add bacon or sausage', '2.09', 70, 'Chef’s Table Breakfast', 'Lady Eaton');
(150, 'Add cheese', '2.09', 80, 'Chef’s Table Breakfast', 'Lady Eaton');
(151, 'Upgrade to bagel', '2.09', 80, 'Chef’s Table Breakfast', 'Lady Eaton');

(152, 'Chicken twister wrap', '10.49', 710, 'Chef’s Table Lunch & Dinner' 'Lady Eaton');
(153, 'Love me tenders', '9.49', 300, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(154, 'Plant-based lightlife burger', '8.99', 530, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(155, 'Jalapeno popper grilled cheese', '9.29', 720, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(156, 'Grilled cheese', '5.79', 470, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(157, 'BLT sandwich', '7.59', 380, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(158, 'Veggie Bagel Supreme', '5.99', 470, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(159, 'Guac toast', '3.79', 440, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(160, 'GLT sandwich', '5.99', 390, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(161, 'Toasted bagel', '2.49', 350, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
(162, 'with cheese or cream cheese', '3.49', 370, 'Chef’s Table Lunch & Dinner', 'Lady Eaton');
